...
{
    public class CreateFoundItemDtoValidator : AbstractValidator<CreateFoundItemDto>
    {
        public CreateFoundItemDtoValidator()
        {
            ...
            RuleFor(x => x.DateFound)
                .NotEmpty().WithMessage("Date found is required")
                .LessThanOrEqualTo(DateTime.UtcNow).WithMessage("Date found cannot be in the future");
